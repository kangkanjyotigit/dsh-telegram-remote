...
// Long underscore rule drawn under every section header (literal _ chars:
// renders identically on every Telegram client, never breaks).
const HEADER_RULE = "______________________________";
const DIVIDER = "─────── ⋆⋅☆⋅⋆ ───────";
